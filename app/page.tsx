...
function InstagramPreviewModal({
  ...
  // Barra "Cancelar" desativa se ja estiver postando
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[11px] text-gray-500 truncate">Paisagismo autoral · São Paulo</div>
          </div>
        ...
        {/* Footer — estado normal / publicando / resultado */}
        <div className="border-t border-gray-200 bg-gray-50 p-3">
          {postResult?.ok ? (
            <div className="text-center">
              ...
              <button
                onClick={onCancel}
                className="mt-3 w-full py-2.5 rounded-lg bg-black text-white text-sm font-medium hover:bg-gray-800"
              >
                Fechar
              </button>
            </div>
